...
while True:
    ...
    if option == 1:
        ...
        options(
            ...
            Addition_info,
            "Addition",
            ("Matrice initiale", matrice),
            ("Matrice à ajouter B", matrice_pour_add),
            ("Résultat de l'addition", adition_matrice),
        )
    ...
    # option 2 = Soustraction
        ...
        options(
            ...
            ("Matrice initiale", matrice),
            ("Matrice à soustraire B", matrice_pour_oustraction),
            ("Résultat de la soustraction", soustraction_matrice),
        )
    ...
    # option 3 = Multiplication
        ...
        options(
            ...
            "Multiplication",
            ("Matrice initiale", matrice),
            ("Matrice à multiplier B", matrice_pour_m),
            ("Résultat de la multiplication", matrice_multiple_par_Matrice),
        )
    ...
    # option 4 = Multiplication par scalaire
        ...
        try:
            scalaire = float(
                input("Veuillez entrer le scalaire à multiplier par la matrice: ")
            )
        except ValueError:
            titre("Error!")
        ...
        options(
            historique_list,
            Multiplication_par_scalaire_info,
            "Multiplication par scalaire",
            ("Matrice initiale", matrice),
            ("Multiplication par scalaire", scalaire),
            (
                "Matrice obtenue après multiplication par le scalaire",
                matrice_multipli_scalaire,
            ),
        )
    ...
    # option 5 = Transposée
        ...
        options(
            ...
            "Transposée",
            ("Matrice initiale", matrice),
            ("Résultat de la transposition", matrice_Transpose),
        )
    # option 6= la puissance d'une matrice
        ...
        try:
            N_pour_la_puissance = int(
                input("Veuillez entrer l'exposant de la matrice :")
            )
        except ValueError:
            titre("Error!")
            print("----> Veuillez entrer un nombre valide !")
        ...
        options(
            ...
            ("Matrice initiale", matrice),
            ("Résultat de la puissance", N_pour_la_puissance),
        )
    ...
    # option 7 = reduction de gauss
        ...
        options(
            historique_list,
            Reduction_Gauss_info,
            "reduction de gauss",
            ("Matrice initiale", matrice_initiale),
            ("reduction de gauss resulta finale", matrice),
        )
    # option 10 : rang
    elif option == 10:
        try:
        ...
        options(
            ...
            "Rang",
            ("Matrice initiale :", matrice_initiale),
            ("Matrice reduite : :", matrice),
            ("Résultat du calcul du rang\nrg(A) =", rang(matrice)),
        )
        ...
        if sous_option == 1:
            ...
            options(
                ...
                "déterminant",
                ("Matrice initiale", matrice),
                ("Résultat de la déterminant de A :\ndet(A)=", det_a),
            )
        elif sous_option == 2:
            ...
            options(
                ...
                "déterminant",
                ("Matrice initiale", matrice),
                ("Résultat de la déterminant de Aᵀ:\ndet(Aᵀ) = ", det_a),
            )
        elif sous_option == 3:
            ...
            options(
                ...
                determinant_info,
                "déterminant",
                ("Matrice initiale A", (matrice)),
                ("Matrice initiale B", (matrice_b)),
                ("det(A) = ", det_a),
                ("det(B) = ", determinant(matrice_b)),
                ("det(AB) = ", axb),
            )
        elif sous_option == 4:
    ...
    # option: Vérifier inversible
        ...
        if determinant(matrice) != 0:
            ...
            options(
                historique_list,
                verifier_inversible_info,
                "Vérifier inversible",
                ("Matrice initiale", matrice),
                ("Résultat\nOn a det(A) = ", det),
                ("Donc, la matrice est inversible car det(A) ≠ ", 0),
            )
        else:
            print(" Résultat :")
            print()
            ...
            options(
                ...
                ("Matrice initiale", matrice),
                ("Résultat\nOn a det(A) = ", det),
                ("Donc, la matrice n'est pas inversible car det(A) = ", 0),
            )
    # option : Vérifier symétrique Trace
        ...
        if Transpose(matrice) == matrice:
            ...
            options(
                historique_list,
                verifier_symetrique_info,
                "Vérifier symétrique Trace",
                ("Matrice initiale", matrice),
                ("--> On a Aᵀ= :", Transpose(matrice)),
                ("Donc, La matrice est symétrique car Aᵀ = A.", None),
            )
        else:
            print("--> On a Aᵀ= :")
            affichage(Transpose(matrice))
        ...
        if diagonale(matrice) is True:
            ...
            options(
                ...
                ("Matrice initiale", matrice),
                (
                    "Donc, La matrice est diagonaleInverse\nDonc, elle est inversible.",
                    None,
                ),
            )
        else:
            ...
            print(
                "Elle ne peut donc pas être considérée comme une matrice diagonale inversible."
            )
            sous_menu()
            options(
                historique_list,
    ...
    # option 15 : trace
        ...
        options(
            ...
            "trace",
            ("Matrice initiale", matrice),
            ("Résultat de la trace", trace(matrice)),
        )
    # option 16 : Inverse
    elif option == 16:
        try:
        ...
        options(
            ...
            "Inverse",
            ("Matrice initiale", matrice),
            ("Résultat du calcul de l'inverse", inverse(matrice)),
        )
